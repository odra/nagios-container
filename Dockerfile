...
RUN yum install -y epel-release && \
    ...
    rpm -V $INSTALL_PKGS && \
    yum clean all && \
    curl --retry 999 --retry-max-time 0 -sSL https://github.com/openshift/origin/releases/download/v1.2.2/openshift-origin-client-tools-v1.2.2-565691c-linux-64bit.tar.gz | tar xzv && \
